                            ...
                            <div className='w-full mt-2 px-4 md:px-5 py-2 pt-5 md:pt-1 md:pb-2 md:mt-0'>
                                ...
                                <form onSubmit={onSubmit} className='w-full flex flex-col gap-y-4 md:gap-y-5'>
                                    ...
                                    <div className='flex justify-between'>
                                            ...
                                            <Link className='md:mt-2 font-semibold bg-red-700 hover:bg-red-600 px-4 md:px-8 py-2 text-white'
                                                    to='/'>
                                                Cancel
                                            </Link>
                                    </div>
                                    ...
                                    <div className='flex'>
                                        ...
                                        <Link to='/register' className='font-semibold ml-2 text-blue-700 hover:text-blue-500 visited:text-purple-700 active:text-red-700'>Register</Link>
                                    </div>
