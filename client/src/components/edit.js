        ...
        <div className='flex flex-col md:flex-row'>
            <div className='flex md:flex-col md:w-[50%] md:h-screen justify-center items-center py-20 md:py-14  lg:py-20 bg-yellow-100 gap-y-3'>
                ...
                <div className="hidden md:block m-auto h-full -rotate-2 z-10">
                    <p className="w-auto m-auto bg-yellow-300 text-2xl font-semibold p-6 md:p-8 lg:p-14 pb-6 text-left shadow-xl">"Once you stop learning, you start dying." 
                ...
                <div className="hidden md:block m-auto h-full rotate-2 z-20">
                    <p className="w-auto m-auto bg-blue-700 text-white text-2xl font-semibold p-6 md:p-8 lg:p-14 pb-6 text-left shadow-xl">"Always desire to learn something useful." 
